...
import { type AppFlow } from '#src/business/service/app-flow.js'
import { AppStarterSpy } from '#src/controller/__mocks__/app-starter-spy.js'
import { AppStarterStatusMapper } from '#src/controller/app-starter.js'
import { logger } from '#src/util/logger.js'

vi.mock('#src/util/logger.js')
vi.mock('#src/business/service/app-flow.js')
